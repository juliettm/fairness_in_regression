...
folder_path = '../results/regression_linear'  # Update this to your specific folder path
...
for file in quartiles_csv_files:
    ...
    mean_data = df.loc['mean', ['accuracies', 'statistical_parity_difference', 'mae_n', 'sp_avg_outcome_n']].round(3)
